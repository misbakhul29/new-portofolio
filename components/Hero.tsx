    ...
    <section className="min-h-screen flex items-center bg-transparent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-3xl mx-auto">
          <p className="text-cyan-400 text-center text-center font-medium mb-2 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Hi, my name is
          </p>
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-400 mb-8 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            I build things for the web.
          </h2>
          <p className="text-lg text-slate-400 text-center max-w-xl mx-auto mb-10 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
