      ...
      <div className="grid md:grid-cols-5 gap-10 items-center">
        <div className="md:col-span-3">
          <div className="text-slate-400 text-lg space-y-4">
            <p>
              Hello! I'm John Doe, a web developer based in Silicon Valley, CA. I have a passion for creating beautiful and functional websites and applications. My journey into web development started back in 2018 when I decided to try editing a simple HTML template — turns out hacking together a custom webpage was a lot of fun!
            </p>
            <p>
            ...
            <p>
              I'm a firm believer in continuous learning and am always looking for new challenges to tackle. When I'm not at the computer, I enjoy hiking, photography, and exploring new coffee shops.
            </p>
          </div>
          <div className="mt-8">
            <a
